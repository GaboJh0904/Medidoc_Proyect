...
import 'package:medidoc_proyect/pages/PersonalCasa.dart';
import 'navBar.dart';
import 'agendarCitaFechaHora.dart';

class EspecialidadesCasa extends StatefulWidget {
  final String titulo;
  final int numFuncion;

  EspecialidadesCasa({required this.titulo, required this.numFuncion});

  @override
  _EspecialidadesCasaState createState() => _EspecialidadesCasaState();
}

class _EspecialidadesCasaState extends State<EspecialidadesCasa> {
  ...
  void _handleButtonPress(String especialidad) {
    switch (widget.numFuncion) {
      ...
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => PersonalCasa(numLista: 1)),
        );
        break;
      case 3:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => PersonalCasa(numLista: 2)),
        );
        break;
      case 4:
