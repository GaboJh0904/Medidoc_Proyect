...
class AsmaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 192, 196, 199),
      appBar: AppBar(
        leading: IconButton(
      ...
      body: ListView(
        children: <Widget>[
          _buildTextImageSection(
            ...
            imageName: 'assets/images/Asma_1.jpg',  // Asegúrate de tener la imagen correcta en tus assets
          ),
          _buildTextImageSection(
            ...
            imageName: 'assets/images/Asma_2.jpg',
          ),
          _buildTextImageSection(
            ...
            imageName: 'assets/images/Asma_4.jpg',
          ),
          _buildTextImageSection(
            ...
            imageName: 'assets/images/Asma_5.jpg',
          ),
          _buildTextImageSection(
            ...
            imageName: 'assets/images/Asma_6.jpg',
          ),
        ],
      ),
    );
